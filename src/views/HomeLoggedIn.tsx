  ...
  return (
    <div className="bg-[#FFFCF8] dark:bg-[#120A0E] text-gray-800 dark:text-[#FFFCF8] py-8 lg:py-12 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="relative bg-gradient-to-r from-[#8B0020]/10 via-[#B31B3A]/5 to-transparent dark:from-[#8B0020]/20 dark:via-[#8B0020]/10 rounded-3xl p-6 sm:p-8 border border-[#8B0020]/10 dark:border-[#C9A84C]/10 overflow-hidden shadow-sm">
          <div className="absolute right-0 top-0 w-64 h-64 bg-[#8B0020]/10 dark:bg-[#8B0020]/5 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-[#1A1118] border border-[#EDE6D9] dark:border-[#C9A84C]/10 rounded-2xl p-5 shadow-sm flex items-center gap-4">
            <div className="p-3 bg-[#8B0020]/5 dark:bg-[#8B0020]/15 text-[#8B0020] dark:text-[#C9A84C] rounded-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              {isEditingBio ? (
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end gap-1.5">
                    ...
                    <button type="button" onClick={handleSaveBio} className="py-1 px-3 bg-[#8B0020] hover:bg-[#B31B3A] text-[10.5px] text-white font-extrabold rounded-lg cursor-pointer shadow-sm">
                      Save
                    </button>
                  </div>
                </div>
          ...
          <div className="lg:col-span-8 space-y-6 text-left">
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" onClick={onGoToMatches} className="text-xs text-[#8B0020] dark:text-[#C9A84C] hover:text-[#B31B3A] dark:hover:text-[#E0C878] font-extrabold flex items-center gap-1 hover:underline cursor-pointer bg-[#8B0020]/5 dark:bg-[#8B0020]/15 px-3 py-1.5 rounded-xl border border-[#8B0020]/10 dark:border-[#C9A84C]/20">
                <span>View All</span>
                <ArrowRight className="h-4 w-4" />
              </button>
            </div>
                      ...
                      <div className="p-4 flex flex-col justify-between grow space-y-3">
                        ...
                        <button type="button" onClick={() => onUnlockClick(profile)} className={`mt-2 w-full py-2.5 text-center text-xs font-bold rounded-xl transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
                          isUnlockedStatus
                            ...
                            : 'bg-[#8B0020]/5 dark:bg-[#8B0020]/15 text-[#8B0020] dark:text-[#C9A84C] hover:bg-[#8B0020]/10 dark:hover:bg-[#8B0020]/25 border border-[#8B0020]/10 dark:border-[#C9A84C]/20'
                        }`}>
                          {isUnlockedStatus ? (
